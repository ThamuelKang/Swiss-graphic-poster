...
! function (a) {
    ...
    return function b(a, c, d) {
        ...
        15: [function (a, b, c) {
            ...
            function M(a) {
                for (var b, c = [], d = 0, e = !1; a.length;) N(a[d]) === e ? (b = a.splice(0, d), b.length && c.push(Q.ucs2.encode(b)), e = !e, d = 0) : d++, d >= a.length && (b = a.splice(0, d), b.length && c.push(Q.ucs2.encode(b)));
                return c
            }
            ...
            d.prototype.calculateOverflowClips = function () {
                this.nodes.forEach(function (a) {
                    if (C(a)) {
                        ...
                        ]), a.clip = e(a) ? a.parent.clip.concat(b) : b, a.backgroundClip = "hidden" !== a.css("overflow") ? a.clip.concat([a.borders.clip]) : a.clip, D(a) && a.cleanDOM()
                ...
                for (var d = L(c.content), e = "url" === d.substr(0, 3), g = document.createElement(e ? "img" : "html2canvaspseudoelement"), h = new T(g, a, b), i = c.length - 1; i >= 0; i--) {
                    var j = f(c.item(i));
                    g.style[j] = c[j]
                }
                ...
                var b = a.contexts.filter(o),
                    c = a.children.filter(C),
                    d = c.filter(B(z)),
                    e = d.filter(B(y)).filter(B(r)),
                    f = c.filter(B(y)).filter(z),
                    h = d.filter(B(y)).filter(r),
                    i = a.contexts.concat(d.filter(y)).filter(q),
                    j = a.children.filter(E).filter(t),
                ...
                var b = Q.ucs2.decode(a.node.data),
                    c = (!this.options.letterRendering || u(a)) && !O(a.node.data),
